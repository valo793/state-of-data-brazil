...
=======================================================================
Gera os entregáveis finais em padrão visual corporativo de consultoria (sem emojis,
ícones vetoriais SVG limpos, sem notas de rodapé acadêmicas, navegação 100% responsiva 16:9).
"""
...
# Ícones Vetoriais SVG Corporativos (Clean & Minimalist)
SVG_ICONS = {
    ...
    "users": '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>',
    "trending": '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg>',
    ...
    "map": '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>',
    "dollar": '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>',
    ...
    "award": '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="7"></circle><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline></svg>',
}


def build_svg_aws_architecture():
    """Gera o diagrama vetorial SVG da Arquitetura AWS para o Slide 4 (sem emojis)."""
    return """
    <svg viewBox="0 0 1100 480" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" style="font-family: 'Segoe UI', system-ui, -apple-system, sans-serif;">
      ...
      <text x="100" y="168" font-size="13" font-weight="bold" fill="#4A148C" text-anchor="middle">Origem Externa</text>
      ...
      <text x="322" y="232" font-size="9" fill="#666" text-anchor="middle">Dados Brutos Preservados</text>
      ...
      <text x="20" y="460" font-size="9" fill="#888" style="font-style: italic;">
        Arquitetura da Plataforma de Dados — Data Lakehouse em 3 Camadas Medallion no Amazon S3 com AWS Glue, PySpark e Amazon Athena
      </text>
    </svg>
    """
...
def generate_presentation_html():
    print("=" * 80)
    print("GERANDO APRESENTAÇÃO EXECUTIVA REFINADA EM HTML (CORPORATIVA / SEM EMOJIS)")
    print("=" * 80)
...
<head>
  ...
  <title>Dados e IA no Brasil — Evidências para Expansão da Instituição Financeira</title>
  <style>
    /* ==========================================================================
       RESET & THEME SYSTEM (PADRÃO CONSULTORIA EXECUTIVA)
       ========================================================================== */
    :root {{
      --navy-dark: #0B1E36;
      --navy-primary: #112A46;
    ...
    * {{
    ...
    /* ==========================================================================
       CONTROLES INTERATIVOS & OVERLAYS (TOOLBAR E DRAWER)
       ========================================================================== */
    #toolbar {{
      position: fixed;
      bottom: 20px;
    ...
    /* ==========================================================================
       PRINT CSS (PDF 16:9 PAISAGEM SEM CONTROLES)
       ========================================================================== */
    @page {{
    ...
    @media print {{
      ...
      .slide-cover {{
        ...
        background: linear-gradient(135deg, #0B1E36 0%, #112A46 50%, #1E3A8A 100%) !important;
...
<body>
  ...
  <div id="presentation-container">
    ...
    <section class="slide-wrapper slide-cover active" id="slide-1" data-title="Capa">
      <div>
        <div class="cover-tag">{SVG_ICONS['compass']} Diagnóstico Estratégico do Mercado de Dados</div>
        <h1 class="cover-title">Dados e IA no Brasil: Evidências para a Expansão de uma Instituição Financeira</h1>
        <p class="cover-subtitle">Diretrizes de Mercado para Contratação, Remuneração, Capacitação, Retenção e Governança de IA com base na série histórica State of Data Brasil (2023–2026)</p>
      </div>

      <div class="cover-cards">
        <div class="cover-card">
          <div class="cover-card-title">{SVG_ICONS['briefcase']} Caso da Instituição Financeira</div>
          <div class="cover-card-desc">Suporte a decisões executivas de atração de talentos, remuneração, formação técnica, políticas de trabalho e investimentos em IA.</div>
        </div>
        <div class="cover-card">
          <div class="cover-card-title">{SVG_ICONS['layers']} Arquitetura Medallion AWS</div>
        ...
        <div class="cover-card">
          <div class="cover-card-title">{SVG_ICONS['database']} Base Consolidada</div>
          <div class="cover-card-desc">14.002 registros históricos (5.293 em 2023–24, 5.215 em 2024–25 e 3.494 em 2025–26) auditados sob rigorosos critérios de integridade estatística.</div>
        </div>
      </div>

      <div class="cover-footer">
        <div>Fonte: Microdados State of Data Brasil (Data Hackers &amp; Bain) | Database AWS: <code>db_state_of_data</code></div>
        <div>Navegue com as teclas direcionais ◀ / ▶ ou utilize o Índice</div>
      </div>
    </section>
    ...
    <!-- ====================================================================
         ...
         ==================================================================== -->
    <section class="slide-wrapper" id="slide-2" data-title="Síntese Executiva">
      <header class="slide-header">
        ...
        <div class="slide-meta-badge">Diretrizes para Tomada de Decisão</div>
      </header>

      <div class="slide-body grid-2col">
        <div class="card card-highlight-blue">
          <div class="card-header">
            <div class="card-icon icon-blue">{SVG_ICONS['target']}</div>
        ...
        <div class="card card-highlight-green">
          <div class="card-header">
            <div class="card-icon icon-green">{SVG_ICONS['trending']}</div>
    ...
    <section class="slide-wrapper" id="slide-3" data-title="Base & Confiabilidade">
      ...
      <div class="slide-body grid-2col">
        <div class="card card-highlight-blue">
          <div class="card-header">
            <div class="card-icon icon-blue">{SVG_ICONS['database']}</div>
          ...
          <table class="table-exec">
            ...
            <tbody>
              <tr><td>Deduplicação de Chave</td><td>Chave <code>(ano, id)</code> com hash SHA-256 para nulos</td><td>Totalmente Auditado</td></tr>
        ...
        <div class="card card-highlight-amber">
          <div class="card-header">
            <div class="card-icon icon-amber">{SVG_ICONS['alert']}</div>
          ...
          <div class="callout callout-warning">
            <strong>Critério Analítico:</strong> Variações temporais indicam mudanças na composição da amostra participante, devendo ser interpretadas com cautela estatística.
          </div>
        </div>
      </div>
    ...
    <section class="slide-wrapper" id="slide-4" data-title="Arquitetura AWS">
      ...
      <div class="slide-body grid-chart-side">
        ...
        <div class="card card-highlight-blue">
          <div class="card-header">
            <div class="card-icon icon-blue">{SVG_ICONS['cpu']}</div>
    ...
    <!-- ====================================================================
         ...
         ==================================================================== -->
    <section class="slide-wrapper" id="slide-5" data-title="Panorama Macroeconômico">
      <header class="slide-header">
        <div class="slide-title-group">
          <span class="slide-tag">Diagnóstico de Mercado</span>
          <h2 class="slide-title">Evolução dos Principais Indicadores do Mercado de Dados</h2>
        </div>
        <div class="slide-meta-badge">Estrutura &amp; Dinâmica do Setor</div>
      </header>
    ...
    <!-- ====================================================================
         ...
         ==================================================================== -->
    <section class="slide-wrapper" id="slide-6" data-title="Distribuição Regional">
      <header class="slide-header">
        <div class="slide-title-group">
        ...
        <div class="slide-meta-badge">Mapeamento Regional</div>
      </header>
    ...
    <section class="slide-wrapper" id="slide-7" data-title="Remuneração & Senioridade">
      <header class="slide-header">
        ...
        <div class="slide-meta-badge">Perfis Mais Valorizados</div>
      </header>
    ...
    <!-- ====================================================================
         ...
         ==================================================================== -->
    <section class="slide-wrapper" id="slide-8" data-title="Uso Real de Ferramentas">
      <header class="slide-header">
        <div class="slide-title-group">
        ...
        <div class="slide-meta-badge">Uso Efetivo no Dia a Dia</div>
      </header>
      ...
      <div class="slide-body grid-chart-side">
        ...
        <div class="tria-container">
          ...
          <div class="tria-block tria-interpretacao">
            <span class="tria-label">2. Interpretação Estratégica</span>
            O ecossistema corporativo é predominantemente multicloud e híbrido. Power BI e AWS são os líderes de execução diária, mas há forte presença combinada de Azure e GCP.
          </div>
          <div class="tria-block tria-implicacao">
            <span class="tria-label">3. Implicação para o Banco</span>
    ...
    <section class="slide-wrapper" id="slide-9" data-title="Competências & Preferências">
      <header class="slide-header">
        ...
        <div class="slide-meta-badge">Preferências Técnicas</div>
      </header>
    ...
    <section class="slide-wrapper" id="slide-10" data-title="Diversidade de Gênero">
      <header class="slide-header">
        ...
        <div class="slide-meta-badge">Equidade &amp; Carreira</div>
      </header>
    ...
    <section class="slide-wrapper" id="slide-11" data-title="Modelos de Trabalho">
      <header class="slide-header">
        ...
        <div class="slide-meta-badge">Retenção de Talentos</div>
      </header>
    ...
    <section class="slide-wrapper" id="slide-12" data-title="Prioridade de IA">
      <header class="slide-header">
        ...
        <div class="slide-meta-badge">Visão da Liderança</div>
      </header>
    ...
    <!-- ====================================================================
         ...
         ==================================================================== -->
    <section class="slide-wrapper" id="slide-13" data-title="Adoção Individual de IA">
      <header class="slide-header">
        <div class="slide-title-group">
        ...
        <div class="slide-meta-badge">Adoção Individual &amp; Ferramentas</div>
      </header>
    ...
    <section class="slide-wrapper" id="slide-14" data-title="Matriz Estratégica">
      <header class="slide-header">
        ...
        <div class="slide-meta-badge">Pilares de Ação</div>
      </header>
    ...
    <section class="slide-wrapper" id="slide-15" data-title="Plano de 90 Dias">
      <header class="slide-header">
        ...
        <div class="slide-meta-badge">Cronograma de Implementação</div>
      </header>

      <div class="slide-body grid-3col">
        <div class="card card-highlight-blue">
          <div class="card-header">
            <div class="card-icon icon-blue">{SVG_ICONS['calendar']}</div>
        ...
        <div class="card card-highlight-amber">
          <div class="card-header">
            <div class="card-icon icon-amber">{SVG_ICONS['layers']}</div>
        ...
        <div class="card card-highlight-green">
          <div class="card-header">
            <div class="card-icon icon-green">{SVG_ICONS['check']}</div>
    ...
    <section class="slide-wrapper" id="slide-16" data-title="Decisões Finais">
      <header class="slide-header">
        ...
        <div class="slide-meta-badge">Diretrizes Finais de Governança</div>
      </header>

      <div class="slide-body grid-3col">
        <div class="card card-highlight-blue">
          <div class="card-header">
            <div class="card-icon icon-blue">{SVG_ICONS['award']}</div>
            <span>1. Capacidades Críticas &amp; Engenharia</span>
          </div>
        ...
        <div class="card card-highlight-green">
          <div class="card-header">
            <div class="card-icon icon-green">{SVG_ICONS['users']}</div>
            <span>2. Atração Distribuída &amp; Flexibilidade</span>
          </div>
          <p style="font-size: 11.5px; color: var(--slate-text); line-height: 1.45; margin-bottom: 10px;">
        ...
        <div class="card card-highlight-purple">
          <div class="card-header">
            <div class="card-icon icon-purple">{SVG_ICONS['shield']}</div>
            <span>3. Pilotos de IA Governados com ROI</span>
          </div>
          <p style="font-size: 11.5px; color: var(--slate-text); line-height: 1.45; margin-bottom: 10px;">
    ...
    <section class="slide-wrapper" id="slide-17" data-title="Anexo 1: Metodologia">
      ...
      <div class="slide-body grid-2col">
        <div class="card">
          <div class="card-header">
            <div class="card-icon icon-blue">{SVG_ICONS['layers']}</div>
    ...
    <!-- ====================================================================
         SLIDE 18: ANEXO 2 — RASTREABILIDADE
         ==================================================================== -->
    <section class="slide-wrapper" id="slide-18" data-title="Anexo 2: Rastreabilidade">
      <header class="slide-header">
        <div class="slide-title-group">
          ...
          <h2 class="slide-title">Anexo 2 — Rastreabilidade das Perguntas e Entregáveis Técnicos</h2>
        </div>
        <div class="slide-meta-badge">Entregáveis Oficiais</div>
      </header>
      ...
      <div class="slide-body grid-full">
        <div class="card" style="padding: 10px 14px;">
          <table class="table-exec" style="font-size: 10.5px;">
            <thead>
              <tr>
                <th style="width: 35%;">Tema / Pergunta de Diagnóstico</th>
            ...
            <tbody>
              <tr>
                <td>1. Estruturação do mercado brasileiro de Dados</td>
                <td>Slides 5 e 6</td>
              ...
              <tr>
                <td>5. Índice de adoção de IA e seu impacto</td>
              ...
              <tr>
                <td>6. Diferenças entre regiões, níveis e modelos</td>
              ...
              <tr>
                <td>7. Oportunidades e desafios para investir em Dados e IA</td>
  ...
  <!-- ====================================================================
       ...
       ==================================================================== -->
  <div id="toolbar">
    <button class="btn-tool" id="btn-toc" title="Abrir Índice de Slides">{SVG_ICONS['layers']} Índice</button>
    ...
    <button class="btn-tool" id="btn-fullscreen" title="Tela Cheia (F)">{SVG_ICONS['target']} Tela Cheia</button>
    <button class="btn-tool" id="btn-print" title="Imprimir / Salvar PDF (Ctrl+P)">{SVG_ICONS['calendar']} PDF</button>
  </div>
